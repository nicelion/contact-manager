...
def find(query):
    ...
    print()
    print(str(amount) + "Records matching" + query)
...
def add():
    print('Add informaton for new contact.')
    ...
    data = {'name': name, 'address': address, "home": home, "email": email, "mobile": mobile, "zip": zipcode, "city": city, "state": state}
